...
//         {
//         Serial.print("Month: ");Serial.println(GPS.month);
//         Serial.print("Day: ");Serial.println(GPS.day);
//         Serial.print("Year: ");Serial.println(GPS.year);
//         Serial.print("Hour: ");Serial.println(GPS.hour);
//         Serial.print("Mintute: ");Serial.println(GPS.minute);
//         Serial.print("Second: ");Serial.println(GPS.seconds);
//         flaggps=1;
//         }
//     }
//     }//end if fix
...
void loop(void) 
{
    ...
    if(waypointNumber>1)
        {
    targetHeading= crossTrackError(distanceToTarget,courseBetweenWaypoints,targetHeading);
    }
...
float crossTrackError(float distance2WP,float tracklegHead,float targetHead )
{
    ...
    // replace with shortest angle function
    if(deltaHeading > 3.14159265)
    {
        deltaHeading = deltaHeading - 3.14159265;
    }
    else if(deltaHeading < -3.14159265)
    {
        deltaHeading = deltaHeading + 3.14159265;
    }
    ...
    if(distanceXT >.5)
    {
        newTargetHeading=targetHead +5;

    }
    else if(distanceXT<-.5)
        {
     ...
     {
        newTargetHeading =targetHead;
     }


    if(newTargetHeading >= 360)
    {
        newTargetHeading = newTargetHeading - 360;
    }
