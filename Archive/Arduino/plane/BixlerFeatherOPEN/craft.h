...
void ControlResponse(float &yawTargetValue, float &rollTargetValue, float &pitchTargetValue, float yawInput, float rollInput, float pitchInput,int test) ;
float control_output(float current_heading, float target_heading);
void ControlResponseWing(float yawTargetValue, float rollTargetValue, float pitchTargetValue, float yawInput, float rollInput, float pitchInput,int test) ;
