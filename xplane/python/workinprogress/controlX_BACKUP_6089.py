...
import time
<<<<<<< HEAD:xplane/python/workinprogress/controlX.py
...
>>>>>>> 7b83f2794651ef9032f4c141466c57467f83267c:xplane/python/controlX.py
	...
	try:
		with xpc.XPlaneConnect() as client:
				...
				while True:
						...
						fcleft=float(a[4])
						fcright=float(a[5])
						# fcright=translate(fcright,1100,1900,1900,1100)
						fcright= ( 0 - fcright) + 0 
						middle = (fcleft + fcright)/2
						ailerondefct = (fcleft - middle)
						# if fcleft > fcright:
						# 	ailerondefct=ailerondefct*-1 

						fcpitch = middle
						fcroll = ailerondefct

						fcthrottle=float(a[6])
						if count > 10:
							print(chr(27) + "[2J")
							# print a
							if choice == 1:
