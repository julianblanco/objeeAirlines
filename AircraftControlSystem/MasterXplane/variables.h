...
extern float throtAcccum;
extern float throtlast;
...
extern float projectedLat;
extern float projectedLong;
...
// extern float utmeast=0;
// extern float utmnorth=0;
// extern String zonez ="";

// extern float calclat;
// extern float calclong;

extern float kalmanLat;
extern float kalmanLong;

extern float timetravel;
extern float timetook;
extern float headingOffset;
extern int takeoff_flag;
